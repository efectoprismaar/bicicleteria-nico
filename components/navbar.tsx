      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 lg:px-8">
        ...
        <nav className="hidden items-center gap-6 md:flex">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-whatsapp px-4 py-2 text-sm font-semibold text-whatsapp-foreground transition-all hover:brightness-110"
          >
        ...
        <div className="border-t border-border bg-card md:hidden">
          <nav className="mx-auto flex max-w-7xl flex-col px-4 py-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-2 flex items-center justify-center gap-2 rounded-lg bg-whatsapp px-4 py-3 text-sm font-semibold text-whatsapp-foreground transition-all hover:brightness-110"
            >
              <WhatsAppIcon className="h-4 w-4" />
